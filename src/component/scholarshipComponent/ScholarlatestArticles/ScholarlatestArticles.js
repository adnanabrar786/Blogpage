...
import "../../blogComponent/latestArticles/latestarticles.css";
import shareIcon from "../../../images/shareIcon.png";
import Rightwork from "./ScholarRightwork/ScholarRightwork";
import axios from "axios";
import "./ScholarlatestArticles.css"

const ScholarlatestArticles = () => {
  ...
  return (
    <div className="LatestArticles_container" id ="Scholar_latest_container">


{/* change work  start*/}

      <div className="ScholarlatestArticles_heading_main_div">
        <div><h1 className="ScholarlatestArticles_article_heading">Latest Scholarship Post</h1></div>
        <div className="ScholarlatestArticles_line_div"></div>
      </div>
...
export default ScholarlatestArticles;
