...
import "./blogShowupperWork.css";
import shareIcon from "../../../images/shareIcon.png"

const BlogShowUpperWork = () => {
  return (
    <div className="BlogShowUpperWork_conatiner">
      ...
      <div className="BlogShowUpperWork_articles_container">
        ...
        <div className="BlogShowUpperWork_paragraph_div_last_line">
          ...
          <p className="BlogShowUpperWork__last_line_date">12 May 2022 12:18 AM</p>
...
export default BlogShowUpperWork;
